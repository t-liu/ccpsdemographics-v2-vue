<template>
  <div id="app">
    <nav class="navbar navbar-expand bg-dark container-fluid px-3 px-sm-5" data-bs-theme="dark">
      <span class="navbar-text py-2">A T-Liu Production</span>
      <button
        class="btn btn-sm btn-outline-light ms-auto d-flex align-items-center gap-2 ral"
        @click="toggleTheme"
          ...
          <div class="col-12 col-sm-10 col-md-10 col-lg-8">
            <div id="briefsummary">
              ...
              <p class="rob">
                ...
                and short blurbs below will provide clarity on the breakdown at a county level and
                by each school.
              </p>
            </div>
            ...
            <div id="ccps-breakdown">
              ...
              <p class="small gray rob">
                ...
                from the 2005-2006 school year to 2014-2015 school year and overall student
                enrollment has slightly decreased within that ten year span. The African-American
                and Hispanic population has seen a 15% and 110% rise, respectively, in that period.
                The white population, in that same time frame, has decreased 36% and had gradual
            ...
            <div id="school-breakdown">
              <div id="school-breakdown-summary">
                ...
                <p class="small gray rob">
                  Due to five new schools that were added after the 2005-2006 school year (North
                  Point High, William A. Diggs Elementary, Theodore G. Davis, Mary B. Neal
                  Elementary, and St. Charles High), student body count for several schools within
                  their proximity has dropped in recent years. Of the 36 schools in Charles County,
                  25 of them entered the 2014-2015 school year with non-Hispanic white students as a
                  minority group. Of those 25 schools, two of them had an African-American student
                  population less than 50%. 12 schools had at least eight percent of their student
                  body represented with Hispanic background entering that same school year.
                </p>
                <p class="small black rob" style="text-align: center">
              ...
              <div id="school-breakdown-notation">
                <p class="gray small rob">
                  <span class="upper fat ral">Note: </span>This analysis includes schools and
                  programs listed under the
                  <a href="http://www.ccboe.com/" target="_blank"
                    >Charles County Board of Education</a
    ...
    <footer>
      <div class="footer">
        ...
        <div class="social-bookmarks">
          <ul>
            <li class="mailto">
              <a href="mailto:thomas.s.liu@gmail.com" target="_blank" title="Personal E-mail">
                <font-awesome-icon :icon="['far', 'envelope']" />
              </a>
            </li>
            <li class="twitter">
              <a href="https://twitter.com/tliu301" target="_blank" title="Personal Twitter">
            ...
            <li class="github">
              <a href="https://github.com/t-liu" target="_blank" title="Personal Github">
...
const toggleTheme = () => {
  ...
  // Set attribute on <html> element so Bootstrap utility layers pick it up globally
